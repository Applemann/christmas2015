...
namespace SkodaChristmas2015.Helper
{
    public static class CultureHelper
    {
        ...
        public static List<string> GetAvailableCultures()
        {
            ...
            foreach (var culture in SkodaChristmas2015.Resources.ChristmasDefault.ResourceManager.Provider.TranslatedApplication.Cultures)
            {
                if (culture.Value.CultureName == "default")
                {
                    _cultures.Add("en");
                }
                else
                {
                    _cultures.Add(culture.Value.CultureName);
                }
            }
        ...
        {
            List<string> _cultures = GetAvailableCultures();
